...
class Woocommerce_Parcelas_Meta_Box extends Woocommerce_Parcelas_Settings{
    ...
    public function add_fswp_product_meta_box(){
        add_meta_box(
            ...
            __('Parcelamento e pagamento à vista', 'woo-parcelas-com-e-sem-juros'), 
            ...
            array(
                'values'    =>  array(
                                    $this->disable_in_cash_key          => __('Desativar preço à vista para este produto', 'woo-parcelas-com-e-sem-juros'),
                                    $this->disable_installments_key     => __('Desativar preço parcelado para este produto', 'woo-parcelas-com-e-sem-juros')
                            )
            )
        );
    }    
