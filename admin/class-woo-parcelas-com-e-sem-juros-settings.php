...
class Woocommerce_Parcelas_Settings{
	...
	public function __construct(){
		...
		$this->style = array(
			'color'			=>	array(
									'title'		=> 	__('Cor: ', 'woo-parcelas-com-e-sem-juros'),
									'function' 	=> 	'fswp_text_callback',
									'class'		=> 	'color-field'
							),
			'font-weight'	=>	array(
									'title'		=> 	__('Peso: ', 'woo-parcelas-com-e-sem-juros'),
			...
			'font-size'		=>	array(
									'title'			=> 	__('Tamanho: ', 'woo-parcelas-com-e-sem-juros'),
									'function' 		=> 	'fswp_text_callback',
									'placeholder'	=>	__('Ex.: 18px ou 1.2em', 'woo-parcelas-com-e-sem-juros')
							)								
		);
	}
	...
	public function fswp_admin_menu(){
		add_submenu_page(
			'woocommerce',
			__('WooCommerce Parcelas com e sem Juros',	'woo-parcelas-com-e-sem-juros'),
			__('Parcelas', 'woo-parcelas-com-e-sem-juros'),
	...
	public function fswp_page_settings(){
		...
		add_settings_field(
			'tipo_pagamento',
			__('Método de Pagamento', 'woo-parcelas-com-e-sem-juros'),
			...
			array(
				...
				'options'	=>	array(
									0	=>	'Sem juros',
									1	=>	'PagSeguro c/juros',
									2	=>	'MercadoPago c/juros'
								),
				'desc'		=>	__('Selecione o método de pagamento que você utiliza em sua loja para fazer o calculo das parcelas.', 'woo-parcelas-com-e-sem-juros'),
				'default'	=> ''
			)
		);	
		...
		add_settings_field(
			'enable_installments', 
			__('Habilitar', 'woo-parcelas-com-e-sem-juros'), 
			...
			array(
				...
				'desc'	=>	__('Marque para ativar.', 'woo-parcelas-com-e-sem-juros')
			)
		);

		add_settings_field(
			'installment_prefix',
			 __('Prefixo', 'woo-parcelas-com-e-sem-juros'), 
			 ...
			 array(
				...
				'default'		=>	'',
				'class'			=>	'regular-text',
				'desc'			=>	__('Escreva o texto que deve vir logo antes da quantidade. Ex.: Em at&eacute; ou Parcele em.', 'woo-parcelas-com-e-sem-juros'),
				'placeholder'	=>	''
			 )
		);
		...
		add_settings_field(
			'installment_qty',
			__('Quantidade de parcelas','woo-parcelas-com-e-sem-juros'), 
			...
			array(
				...
				'default'	=>	2,
				'class'		=> '',
				'desc'		=>	__('Insira a quantidade de parcelas. Valor m&iacute;nimo: 2.', 'woo-parcelas-com-e-sem-juros')
			)
		);

		add_settings_field(
			'installment_suffix', 
			__('Sufixo', 'woo-parcelas-com-e-sem-juros'), 
			array($this, 'fswp_text_callback'), 
			$this->page, 
			'section_general-installments', 
			array(
				...
				'default'		=>	'',
				'class'			=>	'regular-text',
				'desc'			=>	__('Escreva o texto que deve vir logo depois do pre&ccedil;o. Ex.: sem juros ou s/ juros', 'woo-parcelas-com-e-sem-juros'),
				'placeholder'	=>	''
			)
		);
		...
		add_settings_field(
			...
			__('Valor m&iacute;nimo de cada parcela', 'woo-parcelas-com-e-sem-juros'), 
			array($this, 'fswp_text_callback'), 
			$this->page, 
			'section_general-installments', 
			array(
				...
				'default'		=>	0,
				'class'			=> '',
				'desc'			=>	__('Caso o preço de cada parcela tenha um valor mínimo insira-o aqui. Ex.: 5 ou 5,95.<br />Use apenas separador decimal, não use separador de milhar.', 'woo-parcelas-com-e-sem-juros'),
				'placeholder'	=>	''
			)
		);
		...
		add_settings_field(
			...
			array(
				...
				'class'			=> 	'',
				'desc'			=>	__('Escreva o texto que deve vir logo antes do preço à vista. Ex.: ou', 'woo-parcelas-com-e-sem-juros'),
				'default'		=> 	'',
				'placeholder'	=>	''
			)
		);
		...
		add_settings_field(
			'in_cash_discount',
			__('Valor do desconto', 'woo-parcelas-com-e-sem-juros'),
			array($this, 'fswp_text_callback'),
			$this->page,
			'section_general-in_cash',
			array(
				...
				'class'			=>	'',
				'desc'			=>	__('Use apenas separador decimal, não use separador de milhar. Ex.: 4 ou 4,5.', 'woo-parcelas-com-e-sem-juros'),
				'default'		=> 	'',
				'placeholder'	=>	''
			)
		);
		...
		add_settings_field(
			...
			__('Tipo do desconto', 'woo-parcelas-com-e-sem-juros'),
			array($this, 'fswp_select_callback'),
			$this->page,
			'section_general-in_cash',
			array(
				...
				'desc'		=>	__('Quer descontar uma porcentagem ou um valor fixo?', 'woo-parcelas-com-e-sem-juros'),
				'default'	=> ''
			)
		);
		...
		add_settings_field(
			...
			array(
				...
				'class'			=> 	'',
				'desc'			=>	__('Escreva o texto que deve vir logo depois do preço à vista. Ex.: à vista ou no boleto.', 'woo-parcelas-com-e-sem-juros'),
				'default'		=> '',
				'placeholder'	=>	''
			)
		);		
		...
		add_settings_field(
			...
			__('Página que lista os produtos', 'woo-parcelas-com-e-sem-juros'),
			array($this, 'fswp_select_callback'),
			$this->page,
			...
			array(
				...
				'desc'		=>	__('Defina a posição das parcelas, dentro das páginas que listam os produtos, e a prioridade dessa posição abaixo. Padrão: 1.', 'woo-parcelas-com-e-sem-juros'),
				'default'	=> ''
			)
		);
		...
		add_settings_field(
			...
			__('Prioridade', 'woo-parcelas-com-e-sem-juros'),
			array($this, 'fswp_number_callback'),
			$this->page,
			'section_position-position',
			array(
				...
				'default'	=>	15,
				'desc'		=>	__('Seu tema e/ou outros plugins podem disputar uma mesma posição. Use este campo para definir a prioridade para a posição das parcelas. Quanto maior o número, maior a prioridade. Padrão: 15.', 'woo-parcelas-com-e-sem-juros')
			)
		);

		add_settings_field(
			'fswp_in_single_position',
			__('Página individual do produto', 'woo-parcelas-com-e-sem-juros'),
			array($this, 'fswp_select_callback'),
			$this->page,
			'section_position-position',
			array(
				...
				'desc'		=>	__('Defina a posição das parcelas, dentro da página do produto, e a prioridade dessa posição abaixo. Padrão: 1.', 'woo-parcelas-com-e-sem-juros'),
				'default'	=> ''
			)
		);
		...
		add_settings_field(
			...
			array(
				...
				'options'	=>	array(
									'center'	=>	__('Centralizar', 'woo-parcelas-com-e-sem-juros'),
									'right'		=>	__('Alinhar à direita', 'woo-parcelas-com-e-sem-juros'),
									'left'		=>	__('Alinhar à esquerda', 'woo-parcelas-com-e-sem-juros')
								),
				'default'	=>	''
			)
		);
