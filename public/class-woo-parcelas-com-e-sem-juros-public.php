...
class Woocommerce_Parcelas_Public extends Woocommerce_Parcelas_Meta_Box{
    ...
    public function public_stylesheet_and_javascript(){
        wp_enqueue_style(WC_PARCELAS_SLUG.'-public', WC_PARCELAS_URL.'public/css/woo-parcelas-com-e-sem-juros-public.php', array(), WC_PARCELAS_VERSION, 'all');
    }
...
?>
        <script type="text/javascript">
            var x_de = <?php echo "'".__('x de', 'woo-parcelas-com-e-sem-juros')."'"; ?>;
...
<?php
      ...
      public function fswp_variable_installment_calculation_PS(){
?>
        <script type="text/javascript">
            var installment_prefix = <?php echo "'".$this->settings['installment_prefix']."'"; ?>;
            var installment_qty = <?php echo $this->settings['installment_qty']; ?>;
        ...
        <script type="text/javascript" src="<?php echo WC_PARCELAS_URL.'public/js/variable-installment-calculation_PS.js' ?>"></script>
<?php
    }

      public function fswp_variable_installment_calculation_MP(){
?>
        <script type="text/javascript">
            var installment_prefix = <?php echo "'".$this->settings['installment_prefix']."'"; ?>;
            var installment_qty = <?php echo $this->settings['installment_qty']; ?>;
        ...
        <script type="text/javascript" src="<?php echo WC_PARCELAS_URL.'public/js/variable-installment-calculation_MP.js' ?>"></script>
<?php
    }
